...
with open('../../data/fever/label_3', 'r') as f:
    labels_org = f.read()

with open('../../data/fever/sentence_3', 'r') as f:
    sentences = f.read()
	
with open('../../data/fever/claim_3', 'r') as f:
    claims = f.read()

from string import punctuation

labels = labels_org[:-1].split('\n')
lab= []
...
parallel_model.compile(loss='categorical_crossentropy', optimizer=Adam(lr = 0.001) , metrics=['acc'])
